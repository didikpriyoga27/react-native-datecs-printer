...
import DatecsPrinter from "react-native-cazh-datecs-printer";
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{ marginBottom: 15 }}>
          <Button
            title="Print Self Test"
            onPress={() => this.printSelfTest()}
          />
        </View>
        ...
        <View style={{ marginBottom: 15 }}>
          <Button
            ...
            onPress={() => this.print("{reset}{center}Test RN Datecs Printer")}
          />
        </View>
